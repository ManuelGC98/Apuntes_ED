...
Diapositivas: http://jamj2000.github.io/entornosdesarrollo/1/diapositivas#/ <br>
...
- __De sistema__ (Sistema operativo, drivers): programas y aplicaciones referentes al funcionamiento del ordenador.
- __De aplicación__ (Suite ofimática, Navegador, Edición de imagen, ...): programas y aplicaciones referente al uso de aplicaciones.
- __De desarrollo__ (Editores, compiladores, interpretes, ...): programas y aplicaciones referente a la creación de programas.
...
Entrada/Salida de información mediante el hardware.
